...
class EstablishmentScreen extends ConsumerStatefulWidget {
  ...
  static const name = 'establishment-screen';
...
class EstablishmentScreenState extends ConsumerState<EstablishmentScreen> {

  @override
  void initState() {
    super.initState();
    
    ref.read(establishmentProvider.notifier).loadEstablishment(widget.establishmentId);
  ...
  Widget build(BuildContext context) {
    ...
    final Establishment? establishment = ref.watch( establishmentProvider )[widget.establishmentId];
    ...
    return RefreshIndicator(
          ...
          slivers: [
            ...
            SliverList(delegate: SliverChildBuilderDelegate(
              (context, index) => _EstablishmentDetails(
                ...
                onChangeRating: ref.read(establishmentProvider.notifier).saveRating,),
              childCount: 1
            )),
            SliverToBoxAdapter(
              child: Padding(
      ...
      onRefresh: () => ref.read(establishmentProvider.notifier).refreshEstablishment(widget.establishmentId),
    );
  }
}
...
class _EstablishmentDetails extends StatelessWidget {
  ...
  const _EstablishmentDetails({required this.establishment,required this.establishmentId ,required this.onChangeRating});
    ...
    return Column(
      ...
      children: [
              ...
              SizedBox(
                ...
                child:  Row(
                  children: [
                    ...
                    Text('${ establishment.rating }', style: textStyles.bodyMedium?.copyWith( color: Colors.yellow.shade800, fontSize: 25 )),
        ...
        Padding(
          ...
          child: Column(
                  ...
                  children: [
                    ...
                    Text( establishment.schedule.map(
                      (e) => mapperDays[e.day]).toList().join(",") ),
        ...
        Padding(
          ...
          child: Wrap(
            children: [
              ...establishment.preferences.where((pref) => pref.type == "E").map((pref) => Container(
        ...
        Padding(
          ...
          child: Wrap(
            children: [
              ...establishment.preferences.where((pref) => pref.type == "M").map((pref) => Container(
                margin: const EdgeInsets.only( right: 10),
                child: Chip(
                  label: Text( pref.name ),
                  shape: RoundedRectangleBorder( borderRadius: BorderRadius.circular(20)),
